...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.56\textwidth]{../images/generalized_parts/10_diamond_virtual_inheritance.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.7\textwidth]{../images/generalized_parts/10_abstract_shape_class_with_multiple_inheritance.png}
